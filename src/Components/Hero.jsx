        ...
        <div className='heroSection'>
            <div className='heroContainer'>
              <div className='topNav gap-0 md:gap-[15px]'>
                ...
                {/* for middle link */}
                <div className='topnavLink hidden md:flex md:items-center '>
              ...
              <div className='heroContentSection'>
                <div className='heroContent w-[100%] md:w-[35%]'>
                  ...
                  <div className='heroBtn flex flex-col items-center justify-start gap-1 md:flex md:flex-row md:items-center md:justify-between md:gap-24px]'>
